...
urlpatterns = [
    ...
    path('teachers/course/<str:course_name>/lecture_modify/<int:pk>', attendance_views.lecture_modify, name='lecture_modify'),    
    path('teachers/course/<str:course_name>/lecture_delete/<int:pk>', attendance_views.lecture_delete, name='lecture_delete'),        
